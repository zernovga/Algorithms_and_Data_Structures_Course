...
ОТвет: n= 0 или n = 20, для значений до 20*
...
1. На вход получаем масств из чисел
2. предположим, что первое число n максимальное
3. сравниваеи его со следующими
4. если число m больше n, то продолжаем сравнивать m c другими числами
5. продолжаем сравнивать, пока не останется максимальное число
