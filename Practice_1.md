...
Пусть переменная max будет равна 0-му эдементу тогда
Идем по массиву и последовательно сравниваем числа с переменной max. Если число больше, мы изменяем переменную.

Он конечен так как массив не может быть бесконечным

Он определен т.к. у нас простой оператор сравнивания и присваивания

Ввод так как нам подается массив

Вывод у нас наибольшего числа
